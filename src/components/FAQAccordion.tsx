...
export function FAQAccordion({
  ...
  const defaultItems: QA[] =
    lang === "gu"
      ? [
          { q: "આ પ્લેટફોર્મ કોના માટે છે?", a: "ધોરણ 6 થી 12 ના વિદ્યાર્થીઓ, તેમના માતા-પિતા અને શાળાઓ માટે — H B કાપડિયા ન્યૂ હાઈ સ્કૂલ, અમદાવાદ દ્વારા સંચાલિત." },
          ...
          { q: "શું શાળાઓ માટે ગ્રુપ વર્ઝન છે?", a: "હા — 'For Schools' પેજ પરથી કોન્ટેક્ટ કરો. અમે સંપૂર્ણ ઓનબોર્ડિંગ સપોર્ટ આપીએ છીએ." },
        ]
      : [
          { q: "Who is this platform for?", a: "Students in grades 6 to 12, their parents, and schools — run by The H B Kapadia New High School, Ahmedabad." },
          ...
          { q: "Is there a version for schools?", a: "Yes — visit the 'For Schools' page. We offer full onboarding support, bulk reports and counsellor dashboards." },
