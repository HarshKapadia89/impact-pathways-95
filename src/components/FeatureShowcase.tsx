...
export function FeatureShowcase({ lang }: { lang: Lang }) {
  ...
  const features: {
    ...
    },
    {
      ...
      desc: t({
        en: "Search 200+ colleges & universities by name, course, city, state, category and type.",
        gu: "200+ કોલેજો અને યુનિવર્સિટીઓ નામ, કોર્સ, શહેર, રાજ્ય, કેટેગરી અને પ્રકાર મુજબ શોધો.",
        hi: "200+ कॉलेज और विश्वविद्यालय नाम, कोर्स, शहर, राज्य, श्रेणी और प्रकार से खोजें।",
        mr: "200+ महाविद्यालये आणि विद्यापीठे नाव, अभ्यासक्रम, शहर, राज्य, प्रकारानुसार शोधा.",
      }),
      to: "/find-college",
    },
    {
