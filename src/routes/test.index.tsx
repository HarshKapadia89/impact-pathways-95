          ...
          <div className="grid md:grid-cols-3 gap-8 items-end">
            ...
            <div className="rounded-2xl border border-primary/20 bg-card p-5 shadow-sm">
              <div className="flex items-center gap-2 text-xs uppercase tracking-widest text-accent">
                ...
                {t("Real student sample", "વાસ્તવિક વિદ્યાર્થી નમૂનો")}
              </div>
              <div className="mt-2 font-serif text-lg leading-snug">
                {t(
                  "Aarav Patel · Grade 10 — full PDF",
                  "આરવ પટેલ · ધોરણ 10 — સંપૂર્ણ PDF"
                )}
              </div>
              <p className="text-xs text-muted-foreground mt-2">
                {t(
                  "Open the actual 20-page PDF generated by our system for a real Grade-10 sample profile.",
                  "ધોરણ-10 ના વાસ્તવિક નમૂના પ્રોફાઇલ માટે અમારી સિસ્ટમ દ્વારા જનરેટ થયેલ વાસ્તવિક 20-પાનાનો PDF ખોલો."
                )}
              </p>
