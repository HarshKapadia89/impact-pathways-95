...
const OVERLAYS: Record<string, ProfessionOverlay> = {
  ...
  "agricultural-food-engineer": {
    summary: "A Agricultural & Food Engineer applies engineering to farming and food — machinery, irrigation, post-harvest storage and food-processing plants. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "aircraft-maintenance-technician": {
    summary: "A Aircraft Maintenance Technician inspects, services and certifies aircraft systems so every flight leaves the ground airworthy, working to DGCA-approved procedures. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "aircraft-structures-technician": {
    summary: "A Aircraft Structures Technician repairs and reinforces airframes, panels and composite structures, restoring aircraft to certified strength. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "audio-and-video-technologist": {
    summary: "A Audio and Video Technologist engineers sound and picture systems — studio recording chains, broadcast setups, live sound and post-production. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "avionics-and-electronic-technician": {
    summary: "A Avionics and Electronic Technician installs, calibrates and repairs the electronic systems that navigate, communicate and control an aircraft. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "electrical-engineer": {
    summary: "A Electrical Engineer designs and maintains power generation, transmission, distribution and the electrical systems inside plants and buildings. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "electronic-communication-engineer": {
    summary: "A Electronic & Communication Engineer designs the circuits, chips and networks that move information — mobile, satellite, optical and embedded systems. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "electronics-engineer": {
    summary: "A Electronics Engineer designs and tests electronic hardware — from consumer devices and medical equipment to industrial controllers. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "environmental-engineer": {
    summary: "A Environmental Engineer designs systems that keep air, water and land safe — treatment plants, emission control, waste management and impact assessment. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "industrial-engineer": {
    summary: "A Industrial Engineer makes systems more productive — improving layouts, work methods, supply chains, quality and cost across an operation. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "instrumentation-engineer": {
    summary: "A Instrumentation Engineer specifies, installs and maintains measuring and control instruments that keep industrial processes accurate and safe. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "optical-engineer": {
    summary: "A Optical Engineer designs lenses, lasers, fibre optics and imaging systems used in cameras, medical devices, communication and defence. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "aerologist": {
    summary: "A Aerologist studies the upper atmosphere — its winds, pressure and composition — supporting aviation, launches and weather prediction. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "air-traffic-controller": {
    summary: "A Air Traffic Controller keeps aircraft safely separated and flowing — issuing clearances and instructions from the tower or radar centre. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "airline-pilot": {
    summary: "A Airline Pilot flies passengers and cargo safely, commanding the aircraft from pre-flight planning through to landing. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "astrobiologist": {
    summary: "A Astrobiologist investigates whether and how life can exist beyond Earth, combining biology, chemistry and planetary science. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "astrogeologist": {
    summary: "A Astrogeologist studies the rocks, craters and surface processes of planets, moons and asteroids using mission data and meteorites. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "astronaut": {
    summary: "A Astronaut trains for and performs spaceflight missions — operating spacecraft systems, running experiments and conducting spacewalks. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "electrobiologist": {
    summary: "A Electrobiologist studies electrical activity in living systems — nerve and muscle signals — and the instruments that measure them. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "oceanographer": {
    summary: "A Oceanographer studies the ocean — its currents, chemistry, geology and life — supporting fisheries, shipping, climate and coastal safety. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "ontologist": {
    summary: "A Ontologist designs the formal knowledge structures that let machines organise and reason over information in a domain. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
  ...
  "ufologist": {
    summary: "A Ufologist investigates and documents unidentified aerial phenomena reports using rigorous atmospheric, optical and data-analysis methods. In India this work sits inside the Engineering and Technology stream: students take Science with PCM in Class 11–12, qualify through the entrance exams listed below, and specialise during the degree and early working years. The sections that follow set out the study route, the leading institutes, the exams and the day-to-day reality of the job.",
