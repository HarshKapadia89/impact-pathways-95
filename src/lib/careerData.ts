  ...
  },
  {
    ...
    paths: [
      ...
      },
      {
        ...
        description: "MSU Baroda's Faculty of Performing Arts is one of India's premier institutions — Hindustani vocal, instrumental, dance (Bharatanatyam, Kathak) and theatre. Graduates work in films, OTT, music labels, teaching and festivals.",duates work in films, OTT, music labels, teaching and festivals.",",
      },
      {
