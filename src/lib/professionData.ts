...
const ARCHETYPES: Archetype[] = [
  {
    test: /ethical hacker|penetration test|cyber|security analyst|security engineer|security architect|malware|forensic investigator|threat intelligence|soc analyst|red team|blue team|bug bounty|cryptograph|cryptanalyst|devsecops|ciso|vulnerability/i,
    lead: "A {name} protects computer systems, networks and data — finding weaknesses before attackers do, and responding when something goes wrong.",
    duties: [
      "Test applications, networks and cloud systems for exploitable weaknesses.",
      "Monitor alerts, investigate incidents and contain breaches quickly.",
      "Write clear reports with severity ratings and fix recommendations.",
      "Harden configurations, access controls and encryption standards.",
      "Keep up with new attack techniques, tools and compliance requirements.",
    ],
    sectors: ["IT services and product companies", "Banks, fintechs and insurers", "Government, defence and law-enforcement cyber cells", "Consulting firms and independent security research"],
    skills: ["Networking, operating systems and scripting", "Methodical investigation and note-taking", "Ethical discipline and confidentiality", "Continuous self-learning"],
    pros: ["Very high demand and strong salaries", "Certifications count as much as degrees", "Remote and global work is common"],
    cons: ["On-call and incident pressure", "Certifications need regular renewal", "Mistakes carry legal and reputational risk"],
  },
  {
    test: /data scientist|data analyst|machine learning|deep learning|artificial intelligence|ai engineer|ai research|ai product|ai ethics|nlp|natural language|computer vision|mlops|data engineer|analytics engineer|big data|business intelligence|generative ai|prompt engineer|recommendation systems|decision scientist|applied scientist/i,
    lead: "A {name} turns raw data into decisions — building models, pipelines and dashboards that organisations rely on to act.",
    duties: [
      "Frame the business question and decide what data can answer it.",
      "Clean, join and validate data from multiple sources.",
      "Build, train and evaluate statistical or machine-learning models.",
      "Deploy models and monitor their accuracy in production.",
      "Explain findings to non-technical stakeholders with clear visuals.",
    ],
    sectors: ["Technology product companies and start-ups", "Banking, insurance and consulting", "E-commerce, healthcare and manufacturing analytics teams", "Research labs and government data programmes"],
    skills: ["Statistics, probability and linear algebra", "Python, SQL and cloud tooling", "Problem framing and business sense", "Clear data storytelling"],
    pros: ["Among the fastest-growing career tracks in India", "Strong pay and international mobility", "Applies across every industry"],
    cons: ["Tooling changes rapidly and needs constant relearning", "Much of the work is unglamorous data cleaning", "Entry roles are crowded without a portfolio"],
  },
  {
    test: /pilot|cabin crew|flight attendant|air traffic|aircraft maintenance|avionic|aeronaut|aerospace|airline|airport|drone|aviation/i,
    lead: "A {name} works in aviation, where safety rules, licensing and precise procedure govern every part of the job.",
    duties: [
      "Follow standard operating procedures and pre-departure checks without exception.",
      "Coordinate with crew, ground staff and air traffic control.",
      "Log every action, fault and clearance as required by regulation.",
      "Handle passengers or equipment calmly during delays and emergencies.",
      "Renew licences, medicals and recurrent training on schedule.",
    ],
    sectors: ["Scheduled and low-cost airlines", "Airports and ground-handling companies", "Charter, cargo and business aviation", "Regulators, MRO facilities and training academies"],
    skills: ["Situational awareness and calm under pressure", "Precise communication and checklist discipline", "Technical understanding of aircraft systems", "Physical fitness and medical fitness"],
    pros: ["Global travel and an internationally portable licence", "Strong pay once licensed and current", "Highly structured career progression"],
    cons: ["Training and licensing cost is high", "Irregular rosters, night flights and time-zone strain", "Medical fitness must be maintained throughout"],
  },
  {
    test: /merchant navy|deck cadet|ship|marine engineer|master mariner|harbour|port operations|naval architect|maritime|offshore drilling|dredging|bunker|electro-technical officer/i,
    lead: "A {name} works in the maritime industry, keeping vessels, cargo and ports moving safely under international shipping rules.",
    duties: [
      "Stand watch or run operations according to STCW and company procedures.",
      "Maintain machinery, navigation or cargo systems and log all readings.",
      "Coordinate with port authorities, surveyors and shore teams.",
      "Enforce safety, firefighting and pollution-prevention drills.",
      "Complete statutory documentation and certification renewals.",
    ],
    sectors: ["Indian and international shipping companies", "Ports, terminals and dredging corporations", "Offshore oil, gas and survey vessels", "Marine surveying, classification and insurance"],
    skills: ["Technical competence with ship systems", "Discipline and teamwork in confined spaces", "Sea-legs, stamina and medical fitness", "Documentation under maritime law"],
    pros: ["Tax-efficient, high earnings early in the career", "Sea time counts toward globally recognised certificates", "Long shore leave between contracts"],
    cons: ["Months away from home on each contract", "Isolation and demanding shipboard hierarchy", "Job flow follows global shipping cycles"],
  },
  {
    test: /actuar|underwriting analyst|reserving|reinsurance|catastrophe modelling|solvency|capital modelling|pension/i,
    lead: "A {name} prices and manages financial risk using mathematics, statistics and long-term modelling of uncertain events.",
    duties: [
      "Build and validate models for pricing, reserving or capital adequacy.",
      "Analyse mortality, morbidity, claims and investment data.",
      "Prepare regulatory and board reports with clear assumptions.",
      "Advise product teams on profitability and risk appetite.",
      "Study for professional actuarial examinations alongside work.",
    ],
    sectors: ["Life, general and health insurance companies", "Reinsurance and actuarial consulting firms", "Pension and employee-benefit consultancies", "Banking, risk and analytics functions"],
    skills: ["Advanced statistics and probability", "Excel, R and modelling software", "Long-term concentration and exam stamina", "Business communication of technical results"],
    pros: ["Very high earnings once qualified", "Small, respected profession with scarce supply", "Qualification is portable worldwide"],
    cons: ["Exam series can take 6–10 years to clear", "Work is heavily quantitative and detail-bound", "Progression is tied to exam passes, not effort alone"],
  },
  {
    test: /chef|culinary|pastry|bakery|chocolatier|confectioner|sommelier|bartender|mixolog|barista|food stylist|food critic|catering manager|menu designer/i,
    lead: "A {name} works in professional kitchens and food businesses, where consistency, hygiene and speed matter as much as creativity.",
    duties: [
      "Prepare mise en place and execute dishes to a fixed standard.",
      "Control portioning, food cost and wastage.",
      "Maintain hygiene, temperature and food-safety records.",
      "Train and supervise junior kitchen staff during service.",
      "Develop new dishes and refresh menus with seasonal produce.",
    ],
    sectors: ["Hotels, restaurants and resorts", "Cloud kitchens and QSR chains", "Cruise lines, airlines and institutional catering", "Own restaurant, bakery or food brand"],
    skills: ["Knife skills and cooking technique", "Speed and composure during peak service", "Palate and plating sense", "Cost control and team leadership"],
    pros: ["Skill-first career with fast global mobility", "Clear ladder from commis to executive chef", "Strong entrepreneurship potential"],
    cons: ["Long standing hours, nights and weekends", "Physically hot, high-pressure environment", "Early pay is modest until you gain a reputation"],
  },
  {
    test: /psycholog|counsell|counsel(or|ing)|therapist|psychometric|behaviour therap|neuropsych/i,
    lead: "A {name} works with human behaviour and mental health — assessing, supporting and guiding people through structured, evidence-based methods.",
    duties: [
      "Conduct intake interviews and standardised psychological assessments.",
      "Plan and deliver therapy, counselling or intervention sessions.",
      "Track progress against goals and revise the approach with evidence.",
      "Coordinate with families, schools, doctors or employers as needed.",
      "Maintain confidential case notes and follow professional ethics.",
    ],
    sectors: ["Hospitals, clinics and rehabilitation centres", "Schools, colleges and counselling cells", "Corporate HR, assessment and wellbeing teams", "Private practice, NGOs and tele-therapy platforms"],
    skills: ["Active listening and empathy", "Test administration and interpretation", "Boundaries and ethical judgement", "Report writing and case documentation"],
    pros: ["Deeply meaningful, people-centred work", "Rapidly growing demand for mental-health support", "Private practice is realistic after licensing"],
    cons: ["Clinical practice needs RCI-recognised M.Phil / PsyD training", "Emotionally heavy caseloads", "Income builds slowly in the early years"],
  },
  {
    test: /supply chain|logistics|warehouse|inventory|procurement|sourcing|freight|customs|shipping coordinator|fleet|last-mile|demand planner|materials manager|distribution/i,
    lead: "A {name} keeps goods, costs and timelines under control — planning how products move from supplier to customer.",
    duties: [
      "Forecast demand and plan inventory across locations.",
      "Negotiate with suppliers, transporters and 3PL partners.",
      "Track shipments, resolve delays and manage exceptions daily.",
      "Analyse cost per shipment, fill rate and service levels.",
      "Ensure documentation, taxation and customs compliance.",
    ],
    sectors: ["E-commerce and quick-commerce companies", "FMCG, pharma and manufacturing supply chains", "3PL, freight-forwarding and shipping lines", "Retail chains and export houses"],
    skills: ["Planning and numerical analysis", "Negotiation and vendor management", "ERP and analytics tools", "Calm firefighting under time pressure"],
    pros: ["Every industry needs the skill", "Visible cost impact makes promotions fast", "Strong demand from e-commerce growth"],
    cons: ["Operations run on tight, unpredictable timelines", "Field and warehouse travel is common", "Accountability for delays outside your control"],
  },
  {
    test: /officer \(capf\)|assistant commandant|army|navy officer|air force|infantry|artillery|armoured|combat|defence|military|coast guard|fighter pilot|submarine|territorial army|jag/i,
    lead: "A {name} serves in the armed forces, combining leadership of a team with technical skill and personal discipline in demanding conditions.",
    duties: [
      "Lead, train and take responsibility for a unit of personnel.",
      "Plan and execute operational, technical or administrative tasks.",
      "Maintain personal fitness, weapon handling and drill standards.",
      "Handle logistics, discipline and welfare of subordinates.",
      "Serve wherever posted, including field and high-altitude areas.",
    ],
    sectors: ["Indian Army, Navy and Air Force", "Central Armed Police Forces and Coast Guard", "Defence research, ordnance and logistics establishments", "Post-retirement corporate and PSU security leadership"],
    skills: ["Physical fitness and mental toughness", "Leadership and quick decision-making", "Discipline and integrity", "Teamwork under stress"],
    pros: ["Prestige, purpose and lifelong benefits", "Free training, housing, medical and pension", "Leadership responsibility at a very young age"],
    cons: ["Selection through SSB is highly competitive", "Frequent transfers and family separation", "Genuine physical risk in operational areas"],
  },
  {
    test: /ias|ips|indian foreign service|indian revenue|civil service|collector|tehsildar|magistrate officer|municipal commissioner|block development|section officer|probationary officer|public policy/i,
    lead: "A {name} works in public administration, translating law and policy into services that reach citizens on the ground.",
    duties: [
      "Implement government schemes and monitor delivery in the field.",
      "Manage budgets, staff and inter-department coordination.",
      "Take statutory decisions within the powers of the post.",
      "Handle public grievances, hearings and stakeholder consultations.",
      "Prepare notes, reports and policy recommendations for senior levels.",
    ],
    sectors: ["Central and state government departments", "District and local administration", "Regulatory bodies and public sector undertakings", "Policy think-tanks and multilateral agencies"],
    skills: ["Broad general awareness and analytical writing", "Decision-making under public scrutiny", "Negotiation across departments and politics", "Integrity and stamina"],
    pros: ["Wide scope to affect thousands of lives", "Job security, status and structured progression", "Exposure across sectors within one career"],
    cons: ["Extremely competitive multi-year preparation", "Political and administrative pressure", "Frequent transfers and long working hours"],
  },
  {
    test: /translator|interpreter|linguist|lexicograph|localisation|localization|language teacher|language trainer|subtitl|voice-over|philolog/i,
    lead: "A {name} works professionally with language — carrying meaning accurately between speakers, scripts and cultures.",
    duties: [
      "Translate or interpret content while preserving tone and intent.",
      "Research subject-specific terminology before each assignment.",
      "Proofread, edit and quality-check language output.",
      "Adapt content for cultural context, format and audience.",
      "Maintain glossaries, style guides and translation memories.",
    ],
    sectors: ["Publishing, media and OTT localisation", "Government, courts and diplomatic missions", "IT, e-learning and technology localisation teams", "Freelance and agency translation practice"],
    skills: ["Near-native command of two or more languages", "Cultural sensitivity and subject research", "Speed with accuracy", "CAT tools and documentation"],
    pros: ["Rare skill combinations command premium rates", "Freelance and remote work is standard", "Opens diplomatic and international opportunities"],
    cons: ["Income depends on assignment flow", "Machine translation is squeezing routine work", "Certification and constant practice are essential"],
  },
  {
    test: /curator|museolog|archivist|archaeolog|conservator|epigraph|numismat|heritage|art historian|gallery manager|art appraiser/i,
    lead: "A {name} looks after cultural material — researching, preserving and presenting objects, sites or records so they survive for future generations.",
    duties: [
      "Document, catalogue and condition-check collections or sites.",
      "Plan conservation treatment or preventive storage measures.",
      "Research provenance, context and historical significance.",
      "Design exhibitions, displays and public education programmes.",
      "Work with donors, government bodies and researchers.",
    ],
    sectors: ["National, state and private museums", "Archaeological Survey of India and state departments", "Archives, libraries and heritage trusts", "Auction houses, galleries and heritage tourism"],
    skills: ["Historical research and documentation", "Careful handling and conservation technique", "Storytelling for public audiences", "Patience and meticulous record keeping"],
    pros: ["Intellectually rich, culturally meaningful work", "Access to rare material and field sites", "Growing heritage-tourism and digitisation demand"],
    cons: ["Limited number of sanctioned posts", "Government pay scales dominate the field", "Progress in research and funding can be slow"],
  },
  {
    test: /sales|business development|key account|relationship manager|territory|channel partner|medical representative|insurance advisor|franchise manager|customer success/i,
    lead: "A {name} owns revenue — finding customers, understanding their problem and closing business that both sides are happy with.",
    duties: [
      "Build and qualify a pipeline of prospective customers.",
      "Run meetings, demos and negotiations through to closure.",
      "Hit monthly and quarterly targets and report the funnel accurately.",
      "Maintain long-term relationships and grow existing accounts.",
      "Feed customer objections back to product and marketing teams.",
    ],
    sectors: ["Technology, SaaS and IT services", "Banking, insurance and financial products", "FMCG, pharma and consumer durables", "Industrial, B2B and export businesses"],
    skills: ["Listening and persuasive communication", "Resilience after rejection", "Commercial and negotiation sense", "CRM discipline and follow-through"],
    pros: ["Performance-linked income with no ceiling", "Fastest route to leadership for strong performers", "Skills transfer across every industry"],
    cons: ["Constant target pressure", "Income varies with market cycles", "Heavy travel in field roles"],
  },
  {
    test: /founder|entrepreneur|start-?up|business owner|venture capital|angel invest|incubation|chief of staff|franchise owner/i,
    lead: "A {name} builds a business from the ground up — carrying the risk, the decisions and the outcome personally.",
    duties: [
      "Validate the customer problem before committing money to it.",
      "Build the product or service and the team behind it.",
      "Manage cash flow, pricing, compliance and hiring.",
      "Raise capital or reinvest profits to fund growth.",
      "Set direction and adjust fast when the market responds.",
    ],
    sectors: ["Technology and D2C consumer start-ups", "Manufacturing, agri and services businesses", "Family business and franchise operations", "Venture capital, incubators and accelerators"],
    skills: ["Comfort with uncertainty and risk", "Selling, hiring and financial literacy", "Speed of learning and decision-making", "Resilience over long timelines"],
    pros: ["Full ownership of what you build", "Uncapped upside if it works", "Fast, compressed learning across functions"],
    cons: ["No fixed salary or safety net early on", "Most ventures take years to become stable", "Personal stress and long hours are the norm"],
  },
  {
    test: /fitness trainer|strength and conditioning|yoga|pilates|wellness coach|exercise physiolog|spa|naturopath|sports nutrition/i,
    lead: "A {name} helps people improve health, fitness and wellbeing through structured, individualised programmes.",
    duties: [
      "Assess fitness, health history and personal goals before starting.",
      "Design progressive training, diet or therapy plans.",
      "Demonstrate correct technique and correct form during sessions.",
      "Track measurable progress and adapt the plan accordingly.",
      "Keep certification, first-aid and safety knowledge current.",
    ],
    sectors: ["Gyms, studios and fitness chains", "Hospitals, wellness centres and resorts", "Sports academies and corporate wellness programmes", "Independent and online coaching practice"],
    skills: ["Anatomy, physiology and programme design", "Motivation and behavioural coaching", "Personal fitness and demonstration ability", "Client relationship building"],
    pros: ["Fast entry through certification, not long degrees", "Flexible hours and strong independent-practice potential", "Growing health awareness across Indian cities"],
    cons: ["Client-dependent, seasonal income", "Early mornings and late evenings", "Requires personal fitness to be maintained"],
  },
  {
    test: /marketing|brand manager|advertis|copywriter|media planner|public relations|seo|social media|growth marketer|campaign manager|consumer insights/i,
    lead: "A {name} builds demand — understanding the customer, shaping the message and putting it in front of the right audience profitably.",
    duties: [
      "Research the audience, competition and category trends.",
      "Plan campaigns with clear objectives, budget and channels.",
      "Brief creative and media teams and approve the output.",
      "Track performance metrics and optimise spend in-flight.",
      "Report results and refine positioning for the next cycle.",
    ],
    sectors: ["Advertising, media and digital agencies", "Brands and in-house marketing teams", "Start-ups and e-commerce growth teams", "Market research and consulting firms"],
    skills: ["Consumer insight and clear positioning", "Analytics and budget management", "Copy, design and channel literacy", "Collaboration with creative teams"],
    pros: ["Creative and analytical work in equal measure", "Results are measurable and visible", "Freelance and consulting options are strong"],
    cons: ["Deadline-heavy and campaign-cycle driven", "Attribution debates and shifting platform rules", "Performance judged on numbers each month"],
  },
  {
    test: /teacher|professor|lecturer|educator|instructional designer|curriculum|principal|academic coordinator|trainer|librarian/i,
    lead: "A {name} works in education — planning learning, delivering it well and measuring whether students actually understood.",
    duties: [
      "Plan lessons, courses or training modules against learning outcomes.",
      "Teach, facilitate and adapt explanations to different learners.",
      "Design and evaluate assessments fairly.",
      "Mentor students and communicate with parents or managers.",
      "Keep subject knowledge and pedagogy current.",
    ],
    sectors: ["Schools, colleges and universities", "Ed-tech platforms and coaching institutes", "Corporate learning and development teams", "NGOs, skill missions and government education programmes"],
    skills: ["Subject mastery and clear explanation", "Classroom management and patience", "Assessment design", "Empathy for different learning speeds"],
    pros: ["Stable schedules and long-term job security", "Deep, lasting influence on young people", "Clear eligibility route through TET / NET"],
    cons: ["Eligibility exams are competitive", "Administrative and correction workload", "Pay varies widely between institution types"],
  },
  {
    test: /social worker|community development|ngo|csr|development sector|monitoring and evaluation|livelihood|human rights|advocacy|fundraising|volunteer manager|rural development/i,
    lead: "A {name} works in the development sector, running programmes that improve lives in communities with limited resources.",
    duties: [
      "Assess community needs through surveys and field visits.",
      "Design and run programmes within donor budgets and timelines.",
      "Track indicators, outcomes and utilisation for reporting.",
      "Build partnerships with government, donors and local groups.",
      "Document case studies and impact evidence.",
    ],
    sectors: ["NGOs and civil-society organisations", "CSR teams in corporates and foundations", "Government schemes and rural missions", "Multilateral and bilateral development agencies"],
    skills: ["Empathy and community rapport", "Proposal writing and reporting", "Data collection and evaluation", "Patience with slow systemic change"],
    pros: ["Meaningful, purpose-driven work", "Field exposure across diverse communities", "Growing CSR funding creates steady roles"],
    cons: ["Project funding can be short-term", "Pay is lower than corporate equivalents", "Field postings can be remote and demanding"],
  },
  {
    test: /geolog|geophys|hydrogeolog|seismolog|glaciolog|oceanograph|meteorolog|cartograph|gis|remote sensing|geospatial|soil scientist|palaeontolog|mineralog|geographer|surveyor/i,
    lead: "A {name} studies the earth and its systems, combining fieldwork, instruments and spatial data to explain what is happening beneath and above the surface.",
    duties: [
      "Plan and carry out field surveys, sampling or observation campaigns.",
      "Analyse samples, imagery or instrument data in the laboratory.",
      "Map findings using GIS and remote-sensing software.",
      "Prepare technical reports for industry or government use.",
      "Advise on resource, hazard or land-use decisions.",
    ],
    sectors: ["Geological Survey of India, CGWB and state departments", "Oil, gas and mining companies", "ISRO, IMD and environmental consultancies", "Universities and research institutes"],
    skills: ["Field observation and sampling technique", "GIS, remote sensing and data analysis", "Physical stamina for field seasons", "Technical report writing"],
    pros: ["Genuine fieldwork instead of a desk-only career", "Strong PSU and government recruitment", "Geospatial skills are in growing demand"],
    cons: ["Extended field postings in remote areas", "Recruitment cycles depend on government notifications", "Research careers need a PhD"],
  },
  {
